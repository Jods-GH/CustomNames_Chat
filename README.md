...
# CustomNames
Adds Chat support for [CustomNames](https://www.curseforge.com/wow/addons/libcustomnames).

[//]: # (Links)

[Discord]: https://discord.com/invite/v3gYmYamGJ (Join the Discord)
[PayPal]: https://ko-fi.com/jodsderechte (Donate via PayPal)
[Release]: https://github.com/Jodsderechte/CustomNames_Chat/releases/latest (Latest release)
...
[SVG-Release]: https://badgen.net/github/release/Jodsderechte/CustomNames_Chat?style=flat-square
